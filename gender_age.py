...
# Execute the following command to detect from image: python gender_age.py -i 1.jpg  
# Execute the following command to detect from webcam: python gender_age.py
